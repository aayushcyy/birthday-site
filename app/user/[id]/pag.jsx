...
export default function UserPage({ params: paramsPromise }) {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center relative justify-center bg-[#F1EEE0]">
      ...
      {showCard && (
        <div
          className="relative w-[450px] h-[1000px] hidden lg:flex flex-col items-center justify-center cursor-pointer"
          ref={containerRef}
          onClick={handleClick}
        >
          {/* frontside */}
      ...
      <div className="absolute -bottom-48 text-center h-10 w-full font-lexend text-xs ">
        Made with 💗 by Aayush
      </div>
    </div>
  );
